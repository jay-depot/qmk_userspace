...
#define TAB_NUM LT(LAYER_SYMBOLS, KC_TAB)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_split_3x5_3(
       ...
       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,
                      OS_LGUI, OS_LCTL, OS_LSFT,        SPC_BASE, TAB_NUM, ENT_OSL
  ),
...
/** \brief Mouse emulation and pointer functions. */
  [LAYER_POINTER] = LAYOUT_split_3x5_3(
    ...
    XXXXXXX, DRGSCRL, SNIPING, XXXXXXX, XXXXXXX,         XXXXXXX, XXXXXXX, SNIPING, DRGSCRL, _______,
                      OS_LGUI, OS_LCTL, OS_LSFT,         TO_BASE, TAB_NUM, ENT_OSL
  ),
 ...
 */
  [LAYER_OSL] = LAYOUT_split_3x5_3(
    ...
    XXXXXXX, XXXXXXX,  XXXXXXX,   TO_NAV, OS_LALT,        KC_PAUS, XXXXXXX, XXXXXXX, XXXXXXX, KC_QUOT,
                       OS_LALT, OS_LCTL,  OS_LSFT,       SPC_BASE, TAB_NUM, ENT_OSL
  ),
};
